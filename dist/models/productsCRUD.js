...
exports.productsCRUD = void 0;
var database_1 = __importDefault(require("../database"));
var productsCRUD = /** @class */ (function () {
    function productsCRUD() {
    }
    productsCRUD.prototype.index = function () {
    ...
    productsCRUD.prototype.indexOne = function (id) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    productsCRUD.prototype.insert = function (name, quantity, price) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        con = _a.sent();
                        sql = "INSERT INTO products \n        (name,quantity,price)\n        VALUES\n        ('".concat(name, "',").concat(quantity, ",").concat(price, ")\n        RETURNING *");
                        return [4 /*yield*/, con.query(sql)];
                    case 2:
                        res = (_a.sent()).rows[0];
                        con.release();
    ...
    productsCRUD.prototype.edit = function (id, name, quantity, price) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    productsCRUD.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
...
exports.productsCRUD = productsCRUD;
